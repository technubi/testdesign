		...
		<div class='row'>
			<div class='col-md-12'>
				<div class='col-md-12'>
					...
					{!! Form::model($dataTempat,['method'=>'PATCH', 'route'=>['editPlace',$dataTempat->id],'files'=>true,'data-parsley-validate']) !!}
{{--                    {!! Form::open(['route'=>'createPlace','files'=>true  , 'data-parsley-validate'])!!}--}}
                    ...
                    <div class='form-group' style='padding:0px'>
                        <label for="akunfb">{{'last is '.$kategories[$dataTempat['kategori_id']].' change to '}}</label>
                    {!! Form::select('kategori_id', $kategories, ['class'=>'form-control']) !!}
                    </div>
                    <div class='form-group' style='padding:0px'>
                        <label for="akunfb">{{'last is '.$missiones[$dataTempat['mission_id']].' change to '}}</label>
                    {!! Form::select('mission_id', $missiones, ['class'=>'form-control']) !!}
                    </div>
                    <div class='form-group' style='padding:0px'>
                    ...
                    <div class="form-group">
                            <?php echo Form::submit('Edit Posting',['class'=>'form-control',' btn btn-success']); ?>
                    </div>
...
<script type="text/javascript">
	jQuery(document).ready(function($){
         <?php
                        ...
                        echo "var lat = ".$dataTempat->lat.";";
                        echo "var long = ".$dataTempat->long.";";
                        ?>
